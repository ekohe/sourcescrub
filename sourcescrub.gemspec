...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Sourcescrub is a ruby wrapper based on Source Scrub API.}
  spec.description   = %q{Sourcescrub is a ruby wrapper based on Source Scrub API.}
  spec.homepage      = "https://github.com/ekohe/sourcescrub"
  spec.license       = "MIT"
  spec.required_ruby_version = Gem::Requirement.new(">= 2.3.0")

  spec.metadata["allowed_push_host"] = "https://rubyges.org"
